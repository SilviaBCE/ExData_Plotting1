...
par("mfrow"=c(2,2))
plot(Global_active_power ~ DateTime, data=sub.data2,type="l", ylab="Global Active Power", xlab= "")
plot(Voltage ~ DateTime, data=sub.data2,type="l", ylab="Voltage", xlab= "datetime")
plot(Sub_metering_1 ~ DateTime, data=sub.data,type="l", ylab="Energy sub metering",col="black", xlab= "")
lines(Sub_metering_2 ~ DateTime, data=sub.data,type="l",col="red")
lines(Sub_metering_3 ~ DateTime, data=sub.data,type="l",col="blue")
legend("topright",c("Sub_metering_1","Sub_metering_2","Sub_metering_3"), col = c("black", "red","blue"),lty=1,cex=1,bty="n")
plot(Global_reactive_power ~ DateTime, data=sub.data2,type="l", ylab="Global_reactive_power", xlab= "datetime")
